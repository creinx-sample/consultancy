    ...
    <div className="pt-24 min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="p-12 rounded-[3rem] bg-white border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden transition-all hover:border-primary/20">
            <h3 className="text-3xl font-black text-primary mb-10 font-serif uppercase tracking-tight">Our Admission Journey</h3>
            <ul className="space-y-8">
              {[
                ...
                <li key={i} className="flex gap-6 items-start">
                  <span className="w-12 h-12 flex-shrink-0 bg-secondary text-primary rounded-2xl flex items-center justify-center font-black text-xl shadow-lg border-2 border-white rotate-3">{item.step}</span>
                  <div>
                    <h4 className="text-primary font-black text-xl mb-1 tracking-tight font-serif">{item.title}</h4>
          ...
          <div className="p-12 rounded-[3rem] bg-primary border border-indigo-900 shadow-2xl shadow-indigo-100 flex flex-col justify-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-10 -mt-10" />
            <h3 className="text-3xl font-black text-secondary mb-8 font-serif uppercase tracking-tight underline underline-offset-8 decoration-4">Direct Admissions</h3>

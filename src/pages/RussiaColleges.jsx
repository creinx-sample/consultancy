      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        >
          <div className="lg:col-span-1">
            <h2 className="text-[#FF5733] font-bold tracking-widest text-sm uppercase mb-4">The Ideal Destination</h2>
            <h3 className="text-4xl font-black text-[#15803d] font-serif mb-6 leading-tight">Why Study MBBS in Russia?</h3>

    ...
    <section id="services" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-secondary font-bold tracking-widest text-sm uppercase mb-2">Our Key Services</h2>
          <h3 className="text-4xl md:text-5xl font-extrabold text-primary mb-4">Complete Admission Guidance</h3>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 text-secondary font-bold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">

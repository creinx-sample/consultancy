    ...
    <div className="pt-24 min-h-screen bg-slate-50">
      ...
      <div className="bg-[#15803d] py-24 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          >
            A trusted education consultant in Salem, Tamil Nadu, dedicated to helping students secure admissions in top-tier global institutions since 2014.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-[#FF5733] font-bold tracking-widest text-sm uppercase mb-2">Our Mission</h2>
            <h3 className="text-4xl font-extrabold text-[#15803d] mb-6 leading-tight">
              Empowering the Next Generation of Professionals.
            </h3>
            <p className="text-slate-600 mb-6 leading-relaxed font-medium">
              EduGateway was founded with a single mission: to provide honest and transparent career guidance to students after their 12th standard. We specialized in MBBS abroad and premier Indian engineering colleges to bridge the gap between dreams and reality.
            </p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {['WHO/NMC Recognized', 'Low Fee Structure', 'Direct University Admission', 'Salem Office Support', 'Student Visa Guidance', 'Hostel & Mess Facilities'].map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#FF5733]" />
                  <span className="text-[#15803d] font-bold text-sm tracking-wide uppercase">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative p-4">
              <div className="absolute inset-0 bg-[#15803d]/5 rounded-3xl rotate-3 transform scale-105 z-0 border border-slate-200"></div>
              <img 

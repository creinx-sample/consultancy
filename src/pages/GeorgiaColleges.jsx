    ...
    <div className="pt-24 min-h-screen bg-slate-50">
      ...
      <div className="bg-primary py-24 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          ...
          >
            Top Universities in <span className="text-secondary">Georgia</span>
          </motion.h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        >
          <div className="lg:col-span-1">
            <h2 className="text-secondary font-bold tracking-widest text-sm uppercase mb-4">European Excellence</h2>
            <h3 className="text-4xl font-black text-primary font-serif mb-6 leading-tight">Why Choose Georgia?</h3>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="p-12 md:p-20 bg-gradient-to-br from-primary to-[#0f172a] rounded-[4rem] text-center text-white relative overflow-hidden shadow-2xl"
        >
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link to="/contact" className="bg-secondary text-primary px-12 py-5 rounded-2xl font-black uppercase tracking-[0.2em] shadow-xl hover:bg-[#ca8a04] transition-all">Apply Now</Link>
